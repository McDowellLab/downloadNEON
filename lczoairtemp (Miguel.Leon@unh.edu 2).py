...
resultidlist = [17182]
airtempElVerde = read.getResultValues(resultidlist, starttime='2017-01-01',
                                                 endtime= '2017-12-30')
# 17182
datetimes = [] # airtempElVerde['valuedatetime']
for atime in airtempElVerde['valuedatetime']:
    datet = dateutil.parser.parse(atime)
    datetimes.append(datet)

airtemp = airtempElVerde['datavalue']
